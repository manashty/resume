...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
          {Ph.D. in Computer Science;  University of New Brunswick}{2014 -- Dec. 2018}
      {Predictive Analytics in Health Monitoring}{NB, Canada}
%            {University of New Brunswick}{NB, Canada}

    \resumeSubheading
          {M.Sc. in Computer Engineering (AI);  Shahrood University of Technology}{2010 -- 2012}
      {Sign Language Recognition using RGB-D cameras; GPA 3.7/4 (Rank 1/20)}{}

          \resumeSubheading
          {B.Sc. in Software Engineering;  Razi University}{2006 -- 2010}
      {Smart House Remote Monitoring System; GPA 3.7/4 (Rank 3/61)}{}
...
%      {Georgia Institute of Technology}{Atlanta, GA}
      ...
      \resumeItemListStart
        \resumeItem{Primary Lecturer and Lab Instructor}
          {16 Credits, 8 Lab hours \& +150 students, Database Management Systems II | Operating Systems I | Computer Networking | Systems Software Development | C++ for Java Programmers|Honour's Project}
                  \resumeItem{Graduate Research Assistant/Teaching Assistant}{Health Preditcive Analytics @ Fall Lab}
         \resumeItem{Diploma of University Teaching}
          {University of New Brunswick, Fall 2015}
      \resumeItemListEnd
